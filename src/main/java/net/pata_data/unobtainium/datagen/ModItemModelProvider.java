...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.UNOBTAINIUM_HELMET);
        trimmedArmorItem(ModItems.UNOBTAINIUM_CHESTPLATE);
        trimmedArmorItem(ModItems.UNOBTAINIUM_LEGGINGS);
        trimmedArmorItem(ModItems.UNOBTAINIUM_BOOTS);
    }

    // Shoutout to El_Redstoniano for making this
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Unobtainium.MODID; // Change this to your mod id
