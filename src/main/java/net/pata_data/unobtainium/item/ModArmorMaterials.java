...
public enum ModArmorMaterials implements ArmorMaterial {
    UNOBTAINIUM("unobtainium",26, new int[]{5,7,5,4}, 25,
        SoundEvents.ARMOR_EQUIP_NETHERITE, 1f,0f, () -> Ingredient.of(ModItems.UNOBTAINIUM_INGOT.get()));
    ...
    public String getName() {
        return Unobtainium.MODID + ":" + this.name;
    }
